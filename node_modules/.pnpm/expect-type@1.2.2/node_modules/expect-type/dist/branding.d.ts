import type { ConstructorOverloadParameters, NumOverloads, OverloadsInfoUnion } from '.pnpm/expect-type@1.2.2/node_modules/expect-type/dist/overloads';
import type { IsNever, IsAny, IsUnknown, ReadonlyKeys, RequiredKeys, OptionalKeys, MutuallyExtends, UnionToTuple } from '.pnpm/expect-type@1.2.2/node_modules/expect-type/dist/utils';
/**
