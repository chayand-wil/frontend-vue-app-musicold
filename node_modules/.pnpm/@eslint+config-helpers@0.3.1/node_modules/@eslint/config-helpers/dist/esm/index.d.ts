...
export type ExtendsElement = import(".pnpm/@eslint+config-helpers@0.3.1/node_modules/@eslint/config-helpers/dist/esm/types.js").ExtendsElement;
export type SimpleExtendsElement = import(".pnpm/@eslint+config-helpers@0.3.1/node_modules/@eslint/config-helpers/dist/esm/types.js").SimpleExtendsElement;
export type ConfigWithExtends = import(".pnpm/@eslint+config-helpers@0.3.1/node_modules/@eslint/config-helpers/dist/esm/types.js").ConfigWithExtends;
export type InfiniteConfigArray = import(".pnpm/@eslint+config-helpers@0.3.1/node_modules/@eslint/config-helpers/dist/esm/types.js").InfiniteArray<Config>;
export type ConfigWithExtendsArray = import(".pnpm/@eslint+config-helpers@0.3.1/node_modules/@eslint/config-helpers/dist/esm/types.js").ConfigWithExtendsArray;
/**
