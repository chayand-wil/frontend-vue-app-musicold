 ...
 */
export const createMusicGenre = async (artistData) => {
  try {
 ...
 */
export const updateMusicGenre = async (id, artistData) => {
  try {
 ...
 */
export const deleteMusicGenre = async (id) => {
  try {
